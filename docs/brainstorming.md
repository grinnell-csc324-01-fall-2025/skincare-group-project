...
* Slowness in generating results after users submit photos/information
* Doesn't give you results or personalized ones (i.e. recommending the same products over and over)
* Obscure functionality, buttons are not obvious as to how to use them/what they're for
